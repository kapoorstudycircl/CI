...
<html lang="en">
  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <header class="app-header navbar">
      ...
      <img src="<?php echo base_url('assests/src/img/brand/blood_donation.jpg'); ?>" width="130" height="45"/>
              
      
         <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
            <img align="right" class="img-avatar" src="img/avatars/6.jpg" alt="admin@bstmaster.com">
          </a>
  ...
  <div class="dropdown-content">
    <a href="page_list">List_of_Donor</a>
    <a href="page_add">Add_Donor</a>
    </div>
            ...
            <li class="nav-item">
                  <a class="nav-link" href="#">
                    <i class="nav-icon icon-bell"></i> Logout</a>
                </li>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-menu d-md-down-none">
            <div class="btn-group" role="group" aria-label="Button group">
              ...
              <a class="btn" href="./">
                <i class="icon-graph"></i>Logout</a>
              <a class="btn" href="#">
                <i class="icon-settings"></i>  Settings</a>
            </div>
          </li>
        </ol>
        <form action="<?php echo site_url('admin/new_donor'); ?>" method="post">
        <div class="container">
          ...
          <div class="card mx-4">
            <div class="card-body p-4">
              ...
              <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" placeholder="Username" name="username" size="50">
                </div>
              ...
              <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" placeholder="Email Address" name="email"  size="50" >
                   </div>
              ...
              <div class="input-group mb-3">
                ...
                <input class="form-control" type="password" placeholder="Password" name="password" size="50">
                 </div>
                ...
                <input class="form-control" type="password" placeholder="Confirm password" name="confirm_password" size="50">
                </div>
                <?php echo form_error('cconfirm_password',"<p class='text-danger'>","</p>"); ?>
               <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <span class="input-group-text">
                    <i class="icon-user"></i>
                ...
                <input class="form-control" type="text" placeholder="Address" name="address" size="50" >
                   </div>
               ...
               <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" placeholder="city" name="city" size="50" >
                   </div>
               ...
               <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" placeholder="state" name="state" size="50" >
                  </div>
                ...
                <input placeholder="Date" class="textbox-n" type="text" onfocus="(this.type='date')"  id="date" name="date">
                  </div>
    ...
    <footer class="app-footer">
      <div>
        <a href="https://coreui.io">Blood Donor</a>
