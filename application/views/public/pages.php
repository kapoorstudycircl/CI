      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="public/pages.php">
                  ...
                  <div class="col-sm-7 d-none d-md-block">
                    ...
                    <div class="btn-group btn-group-toggle float-right mr-3" data-toggle="buttons">
                      <label class="btn btn-outline-secondary">
                        <input id="option1" type="radio" name="options" autocomplete="off"> Edit
                      </label>
                      <label class="btn btn-outline-secondary active">
                        <input id="option2" type="radio" name="options" autocomplete="off" checked=""> Delete
                      </label>
                      <label class="btn btn-outline-secondary">
                        <input id="option3" type="radio" name="options" autocomplete="off"> Add
                      </label>
                    </div>
                  </div>
                  <!-- /.col-->
